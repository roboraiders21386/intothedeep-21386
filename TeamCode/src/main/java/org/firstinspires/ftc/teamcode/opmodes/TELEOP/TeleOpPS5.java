...
@TeleOp
public class TeleOpPS5 extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            */
            ...
            if (gamepad1.options && gamepad1.triangle) {
                Wrist.setPosition(0);
                Lift.setTargetPosition(3000);//To be updated, Belt is loose
                Lift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                Lift.setPower(liftPow);
                while (Lift.isBusy()) {
                    telemetry.addData("Current Position", Lift.getCurrentPosition());
            ...
            if (gamepad1.options && gamepad1.left_bumper) { //Open
                Claw.setPosition(0.8);
            } else if (gamepad1.options && gamepad1.right_bumper) { //Close
                Claw.setPosition(0.5);
            }
            telemetry.update();
            LF.setPower(0);
